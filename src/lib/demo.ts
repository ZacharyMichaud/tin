...
export function seedDemo(qc: QueryClient): void {
  ...
  const defs = [
    { id: 'tk-fountain', space: 'sp-apt', title: 'Cat fountain filter', kind: 'recurring', interval: 14, notes: 'Wash the pump too', history: [[16, SAM], [31, DEMO_ME], [44, DEMO_ME]] },
    { id: 'tk-plants', space: 'sp-apt', title: 'Water the plants', kind: 'recurring', interval: 3, notes: null, history: [[3, DEMO_ME], [6, SAM], [10, DEMO_ME]] },
    { id: 'tk-vacuum', space: 'sp-apt', title: 'Vacuum living room', kind: 'recurring', interval: 7, notes: null, history: [[2, SAM], [8, DEMO_ME]] },
    { id: 'tk-sheets', space: 'sp-personal', title: 'Wash sheets', kind: 'recurring', interval: 30, notes: null, history: [[12, DEMO_ME], [41, DEMO_ME]] },
    { id: 'tk-litter', space: 'sp-apt', title: 'Deep-clean litter box', kind: 'recurring', interval: 7, notes: null, history: [] },
    { id: 'tk-pillow', space: 'sp-personal', title: 'Buy a new pillow', kind: 'oneoff', interval: null, notes: 'Side-sleeper, medium-firm', history: [] },
    { id: 'tk-curtain', space: 'sp-apt', title: 'Replace shower curtain liner', kind: 'oneoff', interval: null, notes: null, history: [] },
    { id: 'tk-catfood', space: 'sp-apt', title: 'Order cat food', kind: 'oneoff', interval: null, notes: null, history: [[3, SAM]] },
  ] as const
  ...
  for (const d of defs) {
    ...
    tasks.push({
      ...
      interval_days: d.interval, archived: false, created_by: DEMO_ME, created_at: now,
      last: history[0]
